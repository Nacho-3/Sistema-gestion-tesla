...
CREATE TABLE IF NOT EXISTS presupuestos (
  ...
  descuento_tipo VARCHAR(20) NOT NULL DEFAULT 'monto',
  descuento_modo VARCHAR(20) NOT NULL DEFAULT 'auto',
...
ALTER TABLE IF EXISTS presupuestos
  ...
  ADD COLUMN IF NOT EXISTS descuento_tipo VARCHAR(20) NOT NULL DEFAULT 'monto',
  ADD COLUMN IF NOT EXISTS descuento_modo VARCHAR(20) NOT NULL DEFAULT 'auto',
  ...
  ADD COLUMN IF NOT EXISTS descuento_motivo TEXT DEFAULT '',
